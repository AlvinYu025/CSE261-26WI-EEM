...
def parse_args():
    parser = argparse.ArgumentParser(
        description="NY listing-level targets: TF-IDF vs TF-IDF + mismatch (using existing data)."
    )
    parser.add_argument(
        "--listings-path",
        type=str,
    ...
    parser.add_argument(
        "--mismatch-path",
        type=str,
        default="Mismatch_Score/ny/llm_mismatch_score.csv",
        help="Path to NY mismatch CSV",
    )
    parser.add_argument(
        "--baseline-path",
        type=str,
        default="Mismatch_Score/ny/baseline_mismatch_score.csv",
        help="Path to NY baseline mismatch CSV (computed from GloVe baseline).",
    )
    parser.add_argument(
        "--test-size",
        type=float,
